    ...
    <section id="beranda" className="relative w-full overflow-hidden bg-slate-50">
      ...
      <div className="relative min-h-[95vh] flex items-center pt-24 lg:pt-0">
        ...
        <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
          ...
          <div className="absolute top-1/2 right-0 -translate-y-1/2 translate-x-1/4 w-[60vw] max-w-[800px] h-[60vw] max-h-[800px] bg-maroon/25 rounded-full blur-2xl sm:blur-3xl transform-gpu" />
          
          {/* 2. Soft Dynamic Glows for Depth */}
          <div className="absolute top-[-10%] right-[-10%] w-[300px] h-[300px] sm:w-[500px] sm:h-[500px] bg-red-500/20 rounded-full blur-[80px] sm:blur-[120px] transform-gpu hidden sm:block" />
          <div className="absolute bottom-[-10%] left-[-10%] w-[300px] h-[300px] sm:w-[600px] sm:h-[600px] bg-maroon/20 rounded-full blur-[80px] sm:blur-[150px] transform-gpu hidden sm:block" />
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
            ...
            <div className="order-2 lg:order-1 text-center lg:text-left pt-10 lg:pt-0">
              <motion.div
                ...
                className="flex items-center justify-center lg:justify-start gap-2 mb-4 w-full"
              >
              ...
              >
                <a
                  href="#kontak"
                  className="w-full sm:w-auto text-center inline-block px-8 py-4 bg-maroon text-white font-bold rounded-lg shadow-lg shadow-maroon/30 hover:bg-maroon-dark hover:-translate-y-1 transition-all duration-300"
                >
                  CONTACT ME
                </a>
                ...
                <div className="flex items-center gap-3 w-full sm:w-auto">
                  <a
                    ...
                    className="flex-1 sm:flex-none justify-center inline-flex items-center gap-2 px-6 sm:px-8 py-4 bg-white text-maroon font-bold rounded-lg shadow-lg border border-maroon/20 hover:border-maroon hover:bg-slate-50 hover:-translate-y-1 transition-all duration-300"
                  >
                    DOWNLOAD CV
                  ...
                  {/* Social Icons */}
                  <a href="https://linkedin.com/in/maurellio" target="_blank" rel="noreferrer" className="w-[56px] h-[56px] shrink-0 flex items-center justify-center rounded-xl bg-slate-100 text-slate-600 hover:bg-maroon hover:text-white transition-all duration-300 shadow-sm border border-slate-200">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
                  </a>
                  <a href="https://github.com/maurellio" target="_blank" rel="noreferrer" className="w-[56px] h-[56px] shrink-0 flex items-center justify-center rounded-xl bg-slate-100 text-slate-600 hover:bg-slate-900 hover:text-white transition-all duration-300 shadow-sm border border-slate-200">
            ...
            >
              <div className="relative w-full max-w-[320px] sm:max-w-[380px] lg:max-w-[400px]">
                ...
                <div className="w-full aspect-[4/5] rounded-3xl overflow-hidden border-[6px] border-white shadow-2xl rotate-3 hover:rotate-0 transition-transform duration-500 relative z-10 bg-slate-100">
                  <Image
                    src="/profile.jpg"
